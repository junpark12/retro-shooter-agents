...
이 파일은 게임에 사용된 모든 에셋의 출처와 라이선스를 기록합니다.
> ⚠️ 모든 에셋은 상업적 사용 가능 라이선스(CC0, OFL)입니다.
...
| 파일 | 출처 | 작성자 | 라이선스 |
|------|------|--------|----------|
| `fonts/PressStart2P-Regular.ttf` | [Google Fonts / GitHub](https://github.com/google/fonts/tree/main/ofl/pressstart2p) | Cody "CodeMan38" Boisclair | SIL OFL 1.1 |

---

## 🚀 Sprites — Player Ships

> 절차적 생성(Procedurally Generated) — Python/Pillow로 직접 제작

| 파일 | 출처 | 작성자 | 라이선스 |
|------|------|--------|----------|
| `sprites/player/ship_bagon.png` | 자체 제작 (Python/Pillow, 64×64 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/player/ship_damul.png` | 자체 제작 (Python/Pillow, 64×64 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/player/ship_gunex.png` | 자체 제작 (Python/Pillow, 64×64 RGBA) | Galaxy Storm Team | CC0 |
...
| 파일 | 출처 | 작성자 | 라이선스 |
|------|------|--------|----------|
| `sprites/enemies/enemy_small.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/enemies/enemy_medium.png` | 자체 제작 (Python/Pillow, 48×48 RGBA) | Galaxy Storm Team | CC0 |
...
## 💥 Sprites — Bullets & Effects

| 파일 | 출처 | 작성자 | 라이선스 |
|------|------|--------|----------|
| `sprites/bullets/bullet_player.png` | 자체 제작 (Python/Pillow, 8×16 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/bullets/bullet_enemy.png` | 자체 제작 (Python/Pillow, 10×10 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/bullets/bullet_laser.png` | 자체 제작 (Python/Pillow, 4×24 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/effects/explosion_0.png` | 자체 제작 (Python/Pillow, 64×64 RGBA) | Galaxy Storm Team | CC0 |
...
| 파일 | 출처 | 작성자 | 라이선스 |
|------|------|--------|----------|
| `sprites/powerups/powerup_spread.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/powerups/powerup_laser.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/powerups/powerup_missile.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/powerups/powerup_shield.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/powerups/powerup_bomb.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/powerups/powerup_power.png` | 자체 제작 (Python/Pillow, 32×32 RGBA) | Galaxy Storm Team | CC0 |
...
| 파일 | 출처 | 작성자 | 라이선스 |
|------|------|--------|----------|
| `sprites/backgrounds/space_bg.png` | 자체 제작 (Python/Pillow+numpy, 480×640 RGBA) | Galaxy Storm Team | CC0 |
...
| `sprites/ui/bomb_icon.png` | 자체 제작 (Python/Pillow, 24×24 RGBA) | Galaxy Storm Team | CC0 |
| `sprites/ui/power_bar.png` | 자체 제작 (Python/Pillow, 96×12 RGBA) | Galaxy Storm Team | CC0 |

---

## 🎵 BGM (Background Music)

> Python + numpy로 절차적 생성된 칩튠/신스 BGM.
> 포맷: OGG Vorbis (soundfile 라이브러리로 인코딩), 44100 Hz Stereo

| 파일 | 설명 | 분위기 | 길이 | 라이선스 |
|------|------|--------|------|----------|
| `bgm/bgm_title.ogg` | 타이틀 화면 | 미스테리어스·기대감 (BPM 80) | 32초 루프 | CC0 (자체 제작) |
| `bgm/bgm_stage1.ogg` | 스테이지 1 | 신나는 칩튠 테크노 (BPM 160) | 30초 루프 | CC0 (자체 제작) |
| `bgm/bgm_stage2.ogg` | 스테이지 2 | 긴장감 있는 신스 트랜스 (BPM 175) | 30초 루프 | CC0 (자체 제작) |
| `bgm/bgm_stage3.ogg` | 스테이지 3 | 에픽 클라이맥스 (BPM 185) | 32초 루프 | CC0 (자체 제작) |
...
> Python + numpy로 절차적 생성 (사인파·노이즈·포락선 합성).
> 포맷: WAV (PCM 16-bit, 44100 Hz, Mono)

| 파일 | 설명 | 길이 | 라이선스 |
|------|------|------|----------|
| `sfx/sfx_shoot.wav` | 플레이어 기본 발사음 (레이저 pew) | 0.15초 | CC0 (자체 제작) |
| `sfx/sfx_shoot_laser.wav` | 레이저 빔 발사음 | 0.30초 | CC0 (자체 제작) |
| `sfx/sfx_shoot_missile.wav` | 미사일 발사음 (whoosh) | 0.40초 | CC0 (자체 제작) |
| `sfx/sfx_explode_small.wav` | 소형 폭발 | 0.30초 | CC0 (자체 제작) |
| `sfx/sfx_explode_big.wav` | 대형 폭발 | 0.80초 | CC0 (자체 제작) |
| `sfx/sfx_powerup.wav` | 파워업 획득 (상승 차임) | 0.50초 | CC0 (자체 제작) |
| `sfx/sfx_player_hit.wav` | 플레이어 피격 (전기 크래클) | 0.35초 | CC0 (자체 제작) |
| `sfx/sfx_bomb.wav` | 폭탄 사용 (대형 충격파) | 1.00초 | CC0 (자체 제작) |
| `sfx/sfx_lockon.wav` | Lock-on 타겟 고정 | 0.40초 | CC0 (자체 제작) |
| `sfx/sfx_charge.wav` | 차지 공격 (상승 와인) | 1.00초 | CC0 (자체 제작) |
| `sfx/sfx_1up.wav` | 1UP 추가 라이프 (팡파르) | 0.70초 | CC0 (자체 제작) |
| `sfx/sfx_menu_move.wav` | 메뉴 이동 (소프트 틱) | 0.10초 | CC0 (자체 제작) |
| `sfx/sfx_menu_select.wav` | 메뉴 선택 (확인 블립) | 0.20초 | CC0 (자체 제작) |
...
퍼블릭 도메인 헌정 — 저작권·저작인접권 일체 포기.
상업적 이용, 수정, 재배포 자유로이 가능. 귀속(Attribution) 불필요.
> https://creativecommons.org/publicdomain/zero/1.0/

### SIL Open Font License 1.1 (OFL)
글꼴의 자유로운 사용·연구·수정·재배포 허용.
OFL 글꼴을 포함한 소프트웨어를 판매 가능.
단, 글꼴 단독 판매 금지, 파생 글꼴은 동일 라이선스 적용 필요.
...
|------|------|
| Python 3.12 | 스크립트 |
| Pillow (PIL) 12.x | 이미지 생성 |
| NumPy | 오디오 수치 계산 |
| soundfile | OGG Vorbis 인코딩 |
| wave (stdlib) | WAV 파일 출력 |
